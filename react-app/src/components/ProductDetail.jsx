...
function ProductDetail() {
    ...
    return (<>
        <Header />
           <h3 style={{fontFamily:"fantasy",textAlign:'center',padding:'22px'}}>  PRODUCT DETAILS </h3>
        <div >
            {product && <div className="d-flex justify-content-between flex-wrap">
                ...
                <div>
                    <div >
                    <h3 className="m-2 price-text"> Contact No- {product.price} </h3>
                    <p className="m-2"> {product.pname}  | {product.category} </p>
                    <p className="m-2 text-success">add- {product.pdesc} </p>
</div>
                    {product.addedBy &&
